...
{{% alert color="warning" %}}We have identified a regression that occurs when adding associations to a specialization of **System.User**. We have added a [known issue](#ki) below, which has been fixed in [9.14.1](#3154).{{% /alert %}}
